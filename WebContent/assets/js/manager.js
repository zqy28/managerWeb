...
/******/ 	__webpack_require__.p = "/EventManager/assets/js";
/******/
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/sass-loader/index.js!./sty.scss", function() {
				var newContent = require("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/sass-loader/index.js!./sty.scss");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "html {\n  overflow-y: scroll; }\n\nh1,\nh2,\nh3,\nh4,\nh5 {\n  margin: 0px;\n  font: 100%; }\n\nhtml,\nbody {\n  height: 100%; }\n\nth,\ntd {\n  text-align: center; }\n  th input,\n  td input {\n    text-align: center; }\n\n.wrapper {\n  position: relative;\n  min-height: 100%; }\n  .wrapper .wrapper-header {\n    background: #333; }\n    .wrapper .wrapper-header .title-font {\n      color: #FFF;\n      font-size: 180%;\n      line-height: 300%; }\n    .wrapper .wrapper-header #logout-btn {\n      position: absolute;\n      left: 25px;\n      top: 23px;\n      background-color: #666;\n      color: #CCC;\n      padding: 5px 8px;\n      border-radius: 3px;\n      cursor: pointer; }\n      .wrapper .wrapper-header #logout-btn:hover {\n        background: #000;\n        color: #FFF; }\n  .wrapper .wrapper-contents {\n    padding-top: 30px;\n    width: 100%; }\n    .wrapper .wrapper-contents .login-container {\n      padding-top: 30px;\n      margin: 0 auto;\n      width: 290px; }\n    .wrapper .wrapper-contents #navi-bar li a {\n      color: #222; }\n      .wrapper .wrapper-contents #navi-bar li a:hover {\n        background: #AAA; }\n    .wrapper .wrapper-contents #navi-bar .active a {\n      background: #333;\n      color: #CCC; }\n      .wrapper .wrapper-contents #navi-bar .active a:hover {\n        background: #000;\n        color: #FFF; }\n    .wrapper .wrapper-contents .process-message .alert {\n      position: fixed;\n      width: 50%;\n      top: 100px;\n      margin: auto;\n      text-align: center;\n      display: none;\n      z-index: 50; }\n    .wrapper .wrapper-contents #routerview {\n      margin-bottom: 150px; }\n      .wrapper .wrapper-contents #routerview .normal-list-nav a {\n        cursor: pointer; }\n      .wrapper .wrapper-contents #routerview .normal-list-nav .active-navipage a {\n        color: white;\n        background-color: #337ab7; }\n      .wrapper .wrapper-contents #routerview .game-list .btn-group button {\n        margin: 3px; }\n      .wrapper .wrapper-contents #routerview .game-list .lead button {\n        margin: 5px; }\n      .wrapper .wrapper-contents #routerview .game-list .game-list-nav a {\n        cursor: pointer; }\n      .wrapper .wrapper-contents #routerview .game-list .game-list-nav .active-navipage a {\n        color: white;\n        background-color: #337ab7; }\n      .wrapper .wrapper-contents #routerview .reward-pool .reward-pool-table #reward-pool-tbody tr {\n        line-height: 150%; }\n      .wrapper .wrapper-contents #routerview .reward-pool .reward-pool-table #reward-pool-tbody .plus-tip-sig, .wrapper .wrapper-contents #routerview .reward-pool .reward-pool-table #reward-pool-tbody .pool-inject-input, .wrapper .wrapper-contents #routerview .reward-pool .reward-pool-table #reward-pool-tbody .pool-submit-btn {\n        display: none; }\n      .wrapper .wrapper-contents #routerview .reward-pool .reward-pool-table #reward-pool-tbody .pool-inject-input {\n        width: 50px; }\n      .wrapper .wrapper-contents #routerview .reward-rule-manager {\n        display: none; }\n        .wrapper .wrapper-contents #routerview .reward-rule-manager .table tr:hover td {\n          background-color: lightskyblue; }\n        .wrapper .wrapper-contents #routerview .reward-rule-manager .table tr:hover th {\n          background-color: transparent; }\n        .wrapper .wrapper-contents #routerview .reward-rule-manager .table td:nth-child(1) {\n          width: 50%; }\n        .wrapper .wrapper-contents #routerview .reward-rule-manager .table td:nth-child(2) {\n          width: 50%; }\n        .wrapper .wrapper-contents #routerview .reward-rule-manager .table input {\n          width: 50%; }\n          .wrapper .wrapper-contents #routerview .reward-rule-manager .table input:disabled {\n            background-color: transparent;\n            border-style: solid;\n            border-color: transparent; }\n      .wrapper .wrapper-contents #routerview .game-ranking {\n        display: none; }\n        .wrapper .wrapper-contents #routerview .game-ranking .game-ranking-table td:nth-child(1) {\n          width: 15%; }\n        .wrapper .wrapper-contents #routerview .game-ranking .game-ranking-table td:nth-child(2) {\n          width: 20%; }\n        .wrapper .wrapper-contents #routerview .game-ranking .game-ranking-table td:nth-child(3) {\n          width: 30%; }\n        .wrapper .wrapper-contents #routerview .game-ranking .game-ranking-table td:nth-child(4) {\n          width: 40%; }\n      .wrapper .wrapper-contents #routerview .reward-history .reward-history-table td:nth-child(1) {\n        width: 10%; }\n      .wrapper .wrapper-contents #routerview .reward-history .reward-history-table td:nth-child(2) {\n        width: 10%; }\n      .wrapper .wrapper-contents #routerview .reward-history .reward-history-table td:nth-child(3) {\n        width: 15%; }\n      .wrapper .wrapper-contents #routerview .reward-history .reward-history-table td:nth-child(4) {\n        width: 15%; }\n      .wrapper .wrapper-contents #routerview .reward-history .reward-history-table td:nth-child(5) {\n        width: 10%; }\n      .wrapper .wrapper-contents #routerview .reward-history .reward-history-table td:nth-child(6) {\n        width: 10%; }\n      .wrapper .wrapper-contents #routerview .reward-history .reward-history-table td:nth-child(7) {\n        width: 30%; }\n      .wrapper .wrapper-contents #routerview .pop-mask {\n        display: none;\n        position: fixed;\n        left: 0px;\n        top: 0px;\n        z-index: 1;\n        background-color: rgba(0, 0, 0, 0.5);\n        width: 100%;\n        height: 100%; }\n      .wrapper .wrapper-contents #routerview .pop-form {\n        position: absolute;\n        top: 0px;\n        font: 15px Verdana, sans-serif; }\n        .wrapper .wrapper-contents #routerview .pop-form .form-header {\n          width: 100%;\n          box-sizing: border-box;\n          padding-bottom: 10px;\n          border-bottom: 1px solid #ddd;\n          margin-bottom: 15px; }\n          .wrapper .wrapper-contents #routerview .pop-form .form-header h4 {\n            display: inline-block; }\n          .wrapper .wrapper-contents #routerview .pop-form .form-header .pop-close-btn {\n            float: right;\n            border: 0;\n            padding: 0px;\n            background-color: #fff;\n            color: #BBB;\n            cursor: pointer; }\n        .wrapper .wrapper-contents #routerview .pop-form .form-main .form-input {\n          margin-bottom: 8px;\n          font: 70%; }\n          .wrapper .wrapper-contents #routerview .pop-form .form-main .form-input label {\n            box-sizing: border-box;\n            padding-bottom: 3px; }\n          .wrapper .wrapper-contents #routerview .pop-form .form-main .form-input input {\n            box-sizing: border-box;\n            width: 100%;\n            padding: 6px 12px; }\n          .wrapper .wrapper-contents #routerview .pop-form .form-main .form-input .submit-pop-form {\n            float: right;\n            box-sizing: border-box; }\n        .wrapper .wrapper-contents #routerview .pop-form .new-game-form {\n          display: none;\n          position: absolute;\n          z-index: 2;\n          border: 0 solid #000;\n          box-shadow: 0 0 20px #000;\n          box-sizing: border-box;\n          padding: 20px;\n          background-color: #fff; }\n        .wrapper .wrapper-contents #routerview .pop-form .delete-game-form {\n          display: none;\n          position: absolute;\n          z-index: 2;\n          border: 0 solid #000;\n          box-shadow: 0 0 20px #000;\n          box-sizing: border-box;\n          padding: 20px;\n          background-color: #fff; }\n  .wrapper footer {\n    position: absolute;\n    bottom: 0px;\n    height: 100px;\n    width: 100%;\n    padding: 20px;\n    background: #333;\n    font-size: 80%;\n    color: #FFF;\n    margin-top: 20px;\n    text-align: center; }\n", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "\r\n.opacity {\r\n\tbackground-color: #000;\r\n\topacity: 0.5;\r\n}\r\n\r\n.luckyadmin .awards-table,.winner-table {\r\n\tmargin-bottom: 27px;\r\n\tborder: 1px solid #337AB7;\r\n\tborder-radius: 8px;\r\n\tbackground-color: #fff;\r\n}\r\n\r\n.luckyadmin .awards,.winner {\r\n\tbackground-color: #337AB7;\r\n\tcolor: #fff;\r\n\tfont: bold 16px Arial, sans-serif;\r\n\tline-height: 3em;\r\n\ttext-indent: 1em;\r\n\tborder-top-right-radius: 6px;\r\n\tborder-top-left-radius: 6px;\r\n}\r\n\r\n.luckyadmin .item,.info {\r\n\twidth: 100%;\r\n}\r\n\r\n.luckyadmin .item-table,.info-table {\r\n\twidth: 100%;\r\n\tmax-width: 100%;\r\n\t/*border-spacing: 0;*/\r\n\t/*border-collapse: collapse;*/\r\n\t/*overflow: hidden;*/\r\n\tpadding: 0 5px;\r\n}\r\n\r\n.luckyadmin tr {\r\n\twidth: 100%;\r\n\tborder-top: 1px solid #eee;\r\n\theight: 3em;\r\n\tline-height: 3em;\r\n}\r\n\r\n.luckyadmin th {\t\r\n\tfont: bold 14px Verdana, sans-serif;\r\n\tbox-sizing: border-box;\r\n\tpadding: 1px;\r\n\t/*vertical-align: middle;*/\r\n\ttext-align: center;\r\n}\r\n\r\n.luckyadmin td {\r\n\tfont: 14px Verdana, sans-serif;\r\n\tbox-sizing: border-box;\r\n\tpadding: 1px; \r\n\ttext-align: center;\r\n}\r\n\r\n.luckyadmin thead tr {\r\n\tbackground-color: #F9F9F9;\r\n}\r\n\r\n.luckyadmin tr:nth-child(even) {\r\n\tbackground-color: #F9F9F9;\r\n}\r\n\r\n.luckyadmin tbody tr:hover {\r\n\tcursor: pointer;\r\n\tbackground-color: #efe;\r\n}\r\n\r\n.position {\r\n\tposition: absolute;\r\n\ttop: 0;\r\n\tz-index: 9999;\r\n}\r\n\r\n.changegift {\r\n\twidth: 400px;\r\n\t/*height: 570px;*/\r\n\tmargin: 0 auto;\r\n\tborder: 0 solid #000;\r\n\tbox-shadow: 0 0 20px #000;\r\n\tbox-sizing: border-box;\r\n\tpadding: 20px;\r\n\tfont: 15px Verdana, sans-serif;\r\n\tbackground-color: #fff;\r\n}\r\n\r\n.changegift .form-header {\r\n\twidth: 100%;\r\n\tbox-sizing: border-box;\r\n\tpadding: 10px;\r\n\tborder-bottom: 1px solid #ddd;\r\n\tmargin-bottom: 15px;\r\n}\r\n\r\n.changegift .form-header h2 {\r\n\tdisplay: inline-block;\r\n\tfont-size: 16px;\r\n}\r\n\r\n.changegift .form-header .close {\r\n\tfloat: right;\r\n\tborder: 0;\r\n\t/*margin: 3px;*/\r\n\tbackground-color: #fff;\r\n}\r\n\r\n.changegift .form-header .close span {\r\n\tfont-size: 20px;\r\n}\r\n\r\n.changegift .form-main .form-input {\r\n\theight: 70px;\r\n\tmargin-bottom: 8px;\r\n}\r\n\r\n.changegift .form-main .form-input label {\r\n\tbox-sizing: border-box;\r\n\tdisplay: inline-block;\r\n\t/*width: 100px;*/\r\n\tpadding-bottom: 5px;\r\n}\r\n\r\n.changegift .form-main .form-input input {\r\n\tbox-sizing: border-box;\r\n\twidth: 100%;\r\n\tpadding: 6px 12px;\r\n}\r\n\r\n.changegift .form-main .form-input input[type=button] {\r\n\twidth: 25%;\r\n\tfloat: right;\r\n\tborder: none;\r\n\tfont-size: 14px;\r\n\tbox-sizing: border-box;\r\n\tpadding: 10px;\r\n\tbackground-color: #4682B4;\r\n\tborder-radius: 4px;\r\n\tcolor: #fff;\r\n}\r\n\r\n.luckyadmin .page {\r\n\t/*background-color: #aaa;*/\r\n\tdisplay: inline-block;\r\n}\r\n\r\n.luckyadmin .page ul {\r\n\ttext-decoration: none;\r\n}\r\n\r\n.luckyadmin .page ul li {\r\n\tdisplay: inline;\r\n\tfloat: left;\r\n}\r\n\r\n.luckyadmin .page ul li a {\r\n\tfont: normal 1em 'Microsoft yahei';\r\n\ttext-decoration: none;\r\n\tborder: 1px solid #ddd;\r\n\tmargin-left: -1px;\r\n\tpadding: 5px 9px;\r\n}\r\n\r\n.luckyadmin .page ul li a:not(.active):hover {\r\n\tbackground-color: #eee;\r\n\tcursor: pointer;\r\n}\r\n\r\n.luckyadmin .page ul li:first-child a {\r\n\tborder-top-left-radius: 8px;\r\n\tborder-bottom-left-radius: 8px;\r\n}\r\n\r\n.luckyadmin .page ul #next a {\r\n\tborder-top-right-radius: 8px;\r\n\tborder-bottom-right-radius: 8px;\r\n}\r\n\r\n.luckyadmin .page ul li:last-child a {\r\n\tdisplay: inline-block;\r\n\twidth: 40%;\r\n}\r\n\r\n.luckyadmin .page ul li .jump {\r\n\tmargin-top: -5px;\r\n\tfont-size: 14px;\r\n}\r\n\r\n.luckyadmin .page ul li .jump input {\r\n\tbox-sizing: border-box;\r\n\twidth: 20%;\r\n\tpadding: 5px 8px;\r\n\ttext-align: center;\r\n}\r\n\r\n.luckyadmin .page ul li .jump button {\r\n\tmargin-left: 5px;\r\n\tbox-sizing: border-box;\r\n\tpadding: 5px 8px;\r\n\tfont-size: 14px;\r\n\tbackground-color: #fff;\r\n}\r\n\r\n.luckyadmin .page ul li .jump button:hover {\r\n\tcursor: pointer;\r\n}\r\n\r\n.active {\r\n\tbackground-color: #ddd;\r\n}\r\n\r\n.scroll {\r\n\t/*overflow: hidden;*/\r\n}\r\n\r\n.o_position {\r\n\tposition: fixed !important;\r\n\ttop: 0;\r\n\tleft: 0;\r\n\tright: 0;\r\n\tbottom: 0;\r\n\tz-index: 3;\r\n}\r\n\r\n.f_position {\r\n\tposition: fixed !important;\r\n\ttop: 200px;\r\n\tleft: 0;\r\n\tright: 0;\r\n\tbottom: 0;\r\n\tz-index: 9999999;\r\n}\r\n\r\n.tip {\r\n\twidth: 100px;\r\n\theight: 50px;\r\n\tline-height: 50px;\r\n\tmargin: 0 auto;\r\n\ttext-align: center;\r\n\tbackground-color: #87CEEB;\r\n\tborder-radius: 5px;\r\n}\r\n\r\n@media only screen and (max-width: 905px) {\r\n    .luckyadmin {\r\n\t\twidth: 98%;\r\n    }\r\n    .luckyadmin th {\r\n    \tfont-size: 8px;\r\n    }\r\n    .luckyadmin td {\r\n    \tfont-size: 8px;\r\n    }\r\n    .changegift {\r\n    \twidth: 90%;\r\n    \tfont-size: 12px;\r\n    }\r\n    .changegift .form-header h2 {\r\n\t\tfont-size: 14px;\r\n\t}\r\n    .changegift .form-main input[type=button] {\r\n    \tpadding: 3px;\r\n    }\r\n    .position {\r\n    \ttop: 15px;\r\n    }\r\n    .luckyadmin center {\r\n    \tfont-size: 8px;\r\n    }\r\n    .luckyadmin .page ul li:last-child {\r\n\t\twidth: 40%;\r\n\t\tmargin-left: 20px;\r\n\t}\r\n    .luckyadmin .page ul li .jump {\r\n    \tfont-size: 8px;\r\n    }\r\n    .luckyadmin .page ul li #jumppage,#startjump {\r\n    \tfont-size: inherit;\r\n    }\r\n    .luckyadmin .page ul li:last-child {\r\n    \tdisplay: block;\r\n    }\r\n}\r\n@media only screen and (max-width: 515px) {\r\n\t.luckyadmin .page ul li:last-child {\r\n\t\tmargin-top: 20px;\r\n\t\twidth: 60%;\r\n\t}\r\n}", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	(0, _jquery2.default)(document).ready(function () {
	    (0, _jquery2.default)("#login-btn").click(function () {
	        var usrName = (0, _jquery2.default)("#usr-name").val();
	        var usrPassword = (0, _jquery2.default)("#usr-password").val();
	            ...
	            _jquery2.default.ajax({
	                ...
	                success: function success(data) {
	                    if (data.resultCode === "1") {
	                        ...
	                        (0, _jquery2.default)("#login-message").html(data.resultMessage).css("color", "red");
	                    }
	                },
	                error: function error(xhr, status, err) {
	                    ...
	                    (0, _jquery2.default)("#login-message").html(xhr.responseText).css("color", "red");
	                }
	            });
	        } else if (!usrName) {
	            (0, _jquery2.default)("#login-message").html("用户名不能为空").css("color", "red");
	        } else {
	            (0, _jquery2.default)("#login-message").html("用户名应为手机号").css("color", "red");
	        }
	    });
	    (0, _jquery2.default)("#logout-btn").click(function () {
	        _jquery2.default.ajax({
	            type: "POST",
	            url: "logoutAction",
	            cache: false,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _rewardpool = __webpack_require__(17);
	
	var _rewardpool2 = _interopRequireDefault(_rewardpool);
	
	var _gamerule = __webpack_require__(18);
	
	var _gamerule2 = _interopRequireDefault(_gamerule);
	
	var _ranking = __webpack_require__(19);
	
	var _ranking2 = _interopRequireDefault(_ranking);
	
	var _rewardlog = __webpack_require__(20);
	
	var _rewardlog2 = _interopRequireDefault(_rewardlog);
	
	var _prizemanager = __webpack_require__(21);
	
	var _prizemanager2 = _interopRequireDefault(_prizemanager);
	
	var _drawlog = __webpack_require__(22);
	
	var _drawlog2 = _interopRequireDefault(_drawlog);
	...
	(0, _jquery2.default)(document).ready(function () {
	    function Router() {
	        ...
	        this.refresh = function () {
	            ...
	            (0, _jquery2.default)("#navi-bar>li").removeClass("active");
	            if (this.curUrl.length > 1) {
	                (0, _jquery2.default)("#navi-" + this.curUrl.slice(1)).addClass("active");
	            } else {
	                (0, _jquery2.default)("#navi-rewardpool").addClass("active");
	            }
	            this.routes[this.curUrl]();
	        };
	
	        this.init = function () {
	            (0, _jquery2.default)(window).on('load', this.refresh.bind(this));
	            (0, _jquery2.default)(window).on('hashchange', this.refresh.bind(this));
	            (0, _jquery2.default)(window).on('unload', this.refresh.bind(this));
	        };
	    }
	
	    var R = new Router();
	    R.init();
	    var res = (0, _jquery2.default)("#routerview");
	    R.route('/', function () {
	        res.html(_rewardpool2.default);
	        (0, _jquery2.default)('#navi-rewardpool').trigger("rewardpoolEvent");
	    });
	    R.route('/gamerule', function () {
	        res.html(_gamerule2.default);
	        (0, _jquery2.default)('#navi-gamerule').trigger("gameruleEvent");
	    });
	    R.route('/ranking', function () {
	        res.html(_ranking2.default);
	        (0, _jquery2.default)('#navi-ranking').trigger("rankingEvent");
	    });
	    R.route('/rewardlog', function () {
	        res.html(_rewardlog2.default);
	        (0, _jquery2.default)('#navi-rewardlog').trigger("rewardlogEvent");
	    });
	    R.route('/prizemanager', function () {
	        res.html(_prizemanager2.default);
	        (0, _jquery2.default)('#navi-prizemanager').trigger("prizemanagerEvent");
	    });
	    R.route('/drawlog', function () {
	        res.html(_drawlog2.default);
	        (0, _jquery2.default)('#navi-drawlog').trigger("drawlogEvent");
	    });
...
/***/ function(module, exports) {
	...
	module.exports = "<div class=\"panel panel-primary reward-pool\">\r\n    <div class=\"panel-heading\">\r\n        <h4>奖金池\r\n        </h4>\r\n    </div>\r\n    <table class=\"table table-striped reward-pool-table\">\r\n        <thead>\r\n            <tr>\r\n                <th>游戏id</th>\r\n                <th>游戏名</th>\r\n                <th>进水池</th>\r\n                <th colspan=\"2\">注入池</th>\r\n                <th>出水池</th>\r\n            </tr>\r\n        </thead>\r\n        <tbody id=\"reward-pool-tbody\">\r\n        </tbody>\r\n    </table>\r\n</div>\r\n<div class=\"game-list\">\r\n    <div class=\"game-list-nav\" activepage=\"1\">\r\n        <ul class=\"pagination\">\r\n            <li><a>&laquo;</a></li>\r\n            <li id=\"game-nav-next\"><a>&raquo;</a></li>\r\n        </ul>\r\n    </div>\r\n</div>"

/***/ },
/* 18 */
/***/ function(module, exports) {

	module.exports = "<div class=\"game-list\">\r\n    <h4 class=\"lead\">选择游戏<button type=\"button\" class=\"btn btn-success\" id=\"new-game-btn\">新增规则</button><button type=\"button\" class=\"btn btn-danger\"\r\n            id=\"delete-game-btn\">删除规则</button></h4>\r\n    <div class=\"btn-group\">\r\n    </div>\r\n    <div class=\"game-list-nav\" activepage=\"1\">\r\n        <ul class=\"pagination\">\r\n            <li><a>&laquo;</a></li>\r\n            <li id=\"game-nav-next\"><a>&raquo;</a></li>\r\n        </ul>\r\n    </div>\r\n</div>\r\n<div class=\"contents-manager\">\r\n    <div class=\"panel panel-primary reward-rule-manager\">\r\n        <div class=\"panel-heading\">\r\n            <h4>奖金规则\r\n                <button type=\"button\" class=\"btn btn-warning\" id=\"change-reward-rule\">修改</button>\r\n                <button type=\"button\" class=\"btn btn-success\" id=\"confirm-change-rule\" appid=\"\" style=\"display:none\">确定</button>\r\n</h4>\r\n</div>\r\n<table class=\"table exist-gamerule-table\">\r\n\r\n    <thead>\r\n        <tr>\r\n            <th>项目</th>\r\n            <th>设定值</th>\r\n        </tr>\r\n    </thead>\r\n    <tbody>\r\n        <tr>\r\n            <td>价格</td>\r\n            <td><span><input disabled id=\"basicpay\"></span>元</td>\r\n        </tr>\r\n        <tr>\r\n            <td>返现基准分</td>\r\n            <td><span><input disabled id=\"basePoint\"></span>分</td>\r\n        </tr>\r\n        <tr>\r\n            <td>进阶一</td>\r\n            <td><span><input disabled id=\"upPercentageOne\"></span>%<br /><span><input disabled id=\"rewardOne\"></span>元</td>\r\n\r\n        </tr>\r\n        <tr>\r\n            <td>进阶二</td>\r\n            <td><span><input disabled id=\"upPercentageTwo\"></span>%<br /><span><input disabled id=\"rewardTwo\"></span>元</td>\r\n        </tr>\r\n        <tr>\r\n            <td>大奖</td>\r\n            <td><span><input disabled id=\"finalPoint\"></span>分<br /><span><input disabled id=\"finalreward\" value=\"1000\"></span>元</td>\r\n\r\n        </tr>\r\n    </tbody>\r\n</table>\r\n</div>\r\n</div>\r\n<div class=\"pop-mask\"></div>\r\n<div class=\"pop-form col-xs-12 col-sm-8 col-sm-offset-1 col-md-6 col-md-offset-1 col-lg-6 col-lg-offset-2\">\r\n    <form class=\"new-game-form\">\r\n        <div class=\"form-header\">\r\n            <h4>新增游戏规则</h4>\r\n            <button class=\"pop-close-btn glyphicon glyphicon-remove\">\r\n\t\t\t\t</button>\r\n        </div>\r\n        <div class=\"form-main\">\r\n            <div class=\"form-input\">\r\n                <label for=\"new-game-id\">游戏id: </label>\r\n                <input id=\"new-game-id\" type=\"text\">\r\n            </div>\r\n            <div class=\"form-input\">\r\n                <label for=\"new-game-price\">价格：</label>\r\n                <input id=\"new-game-price\" type=\"text\">\r\n            </div>\r\n            <div class=\"form-input\">\r\n                <label for=\"new-game-basicpoint\">返现基准分：</label>\r\n                <input id=\"new-game-basicpoint\" type=\"text\">\r\n            </div>\r\n            <div class=\"form-input\">\r\n                <label for=\"new-game-upPercentageOne\">进阶一条件：</label>\r\n                <input id=\"new-game-upPercentageOne\" type=\"text\">\r\n            </div>\r\n            <div class=\"form-input\">\r\n                <label for=\"new-game-rewardOne\">进阶一奖金：</label>\r\n                <input id=\"new-game-rewardOne\" type=\"text\">\r\n            </div>\r\n            <div class=\"form-input\">\r\n                <label for=\"new-game-upPercentageTwo\">进阶二条件：</label>\r\n                <input id=\"new-game-upPercentageTwo\" type=\"text\">\r\n            </div>\r\n            <div class=\"form-input\">\r\n                <label for=\"new-game-rewardTwo\">进阶二奖金：</label>\r\n                <input id=\"new-game-rewardTwo\" type=\"text\">\r\n            </div>\r\n            <div class=\"form-input\">\r\n                <label for=\"new-game-finalpoint\">大奖分数：</label>\r\n                <input id=\"new-game-finalpoint\" type=\"text\">\r\n            </div>\r\n            <div class=\"form-input\">\r\n                <label for=\"new-game-finalreward\">大奖奖金：</label>\r\n                <input disabled id=\"new-game-finalreward\" type=\"text\" value=\"1000\">\r\n            </div>\r\n            <div class=\"form-input\">\r\n                <button type=\"button\" class=\"btn btn-success submit-new-gamerule submit-pop-form\">提交</button>\r\n            </div>\r\n        </div>\r\n    </form>\r\n    <form class=\"delete-game-form\">\r\n        <div class=\"form-header\">\r\n            <h4>删除游戏规则</h4>\r\n            <button class=\"pop-close-btn glyphicon glyphicon-remove\">\r\n\t\t\t\t</button>\r\n        </div>\r\n        <div class=\"form-main\">\r\n            <div class=\"form-input\">\r\n                <label for=\"delete-game-id\">游戏id: </label>\r\n                <input id=\"delete-game-id\" type=\"text\">\r\n            </div>\r\n            <div class=\"form-input\">\r\n                <button type=\"button\" class=\"btn btn-danger delete-exist-gamerule submit-pop-form\">确认删除</button>\r\n            </div>\r\n        </div>\r\n    </form>\r\n</div>"

/***/ },
/* 19 */
/***/ function(module, exports) {

	module.exports = "<div class=\"game-list\">\r\n    <h4 class=\"lead\">选择游戏</h4>\r\n    <div class=\"btn-group\">\r\n    </div>\r\n    <div class=\"game-list-nav\" activepage=\"1\">\r\n        <ul class=\"pagination\">\r\n            <li><a>&laquo;</a></li>\r\n            <li id=\"game-nav-next\"><a>&raquo;</a></li>\r\n        </ul>\r\n    </div>\r\n</div>\r\n\r\n<div class=\"panel panel-primary game-ranking\">\r\n    <div class=\"panel-heading\">\r\n        <h4>排名前20</h4>\r\n    </div>\r\n    <table class=\"table table-striped game-ranking-table\">\r\n        <thead>\r\n            <tr>\r\n                <th>名次</th>\r\n                <th>玩家ID</th>\r\n                <th>得分</th>\r\n                <th>添加时间</th>\r\n            </tr>\r\n        </thead>\r\n        <tbody id=\"game-ranking-tbody\">\r\n        </tbody>\r\n    </table>\r\n</div>"

/***/ },
/* 20 */
/***/ function(module, exports) {

	module.exports = "<div class=\"panel panel-primary reward-history\">\r\n    <div class=\"panel-heading reward-history-btn\">\r\n        <h4>得奖历史</h4>\r\n    </div>\r\n\r\n        <table class=\"table table-striped reward-history-table\">\r\n            <thead>\r\n                <tr>\r\n                    <th>ID</th>\r\n                    <th>玩家ID</th>\r\n                    <th>设备号</th>\r\n                    <th>挑战游戏</th>\r\n                    <th>花费</th>\r\n                    <th>得奖</th>\r\n                    <th>挑战时间</th>\r\n                </tr>\r\n            </thead>\r\n            <tbody id=\"game-rewardlog-tbody\">\r\n            </tbody>\r\n        </table>\r\n    \r\n</div>\r\n<div class=\"normal-list-nav\" activepage=\"1\">\r\n    <ul class=\"pagination\">\r\n        <li><a>&laquo;</a></li>\r\n        <li id=\"log-nav-next\"><a>&raquo;</a></li>\r\n    </ul>\r\n</div>"

/***/ },
/* 21 */
/***/ function(module, exports) {

	module.exports = "<div class=\"luckyadmin\" style=\"display: block;\">\r\n\t\t<div class=\"awards-table\">\r\n\t\t\t<div class=\"awards\">\r\n\t\t\t\t奖品信息管理\r\n\r\n\t\t\t</div>\r\n\t\t\t<div class=\"item\">\r\n\t\t\t\t<table class=\"item-table\">\r\n\t\t\t\t\t<thead>\r\n\t\t\t\t\t\t<tr>\r\n\t\t\t\t\t\t\t<th>#</th>\r\n\t\t\t\t\t\t\t<th>奖项</th>\r\n\t\t\t\t\t\t\t<th>奖品详情</th>\r\n\t\t\t\t\t\t\t<th>领奖方式</th>\r\n\t\t\t\t\t\t\t<th>库存</th>\r\n\t\t\t\t\t\t</tr>\r\n\t\t\t\t\t</thead>\r\n\t\t\t\t\t<tbody id=\"prizelist\">\r\n\t\t\t\t\t\t<tr>\r\n\t\t\t\t\t\t\t<th>1</th>\r\n\t\t\t\t\t\t\t<td>一等奖</td>\r\n\t\t\t\t\t\t\t<td>100元电影兑换券</td>\t\t\t\r\n\t\t\t\t\t\t\t<td style=\"display: none;\">https://jinshuju.net/f/QhOuQU</td>\r\n\t\t\t\t\t\t\t<td style=\"display: table-cell;\"></td>\r\n\t\t\t\t\t\t\t<td class=\"remain\">10</td>\t\t\t\t\t\t\t\r\n\t\t\t\t\t\t</tr>\r\n\t\t\t\t\t\t<tr>\r\n\t\t\t\t\t\t\t<th>2</th>\r\n\t\t\t\t\t\t\t<td>二等奖</td>\r\n\t\t\t\t\t\t\t<td>33元哈根达斯券</td>\t\t\t\r\n\t\t\t\t\t\t\t<td style=\"display: none;\">https://jinshuju.net/f/wHHYo7</td>\r\n\t\t\t\t\t\t\t<td style=\"display: table-cell;\"></td>\r\n\t\t\t\t\t\t\t<td class=\"remain\">10</td>\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\r\n\t\t\t\t\t\t</tr>\r\n\t\t\t\t\t\t<tr>\r\n\t\t\t\t\t\t\t<th>3</th>\r\n\t\t\t\t\t\t\t<td>三等奖</td>\r\n\t\t\t\t\t\t\t<td>月度爱奇艺会员</td>\r\n\t\t\t\t\t\t\t<td style=\"display: none;\">https://jinshuju.net/f/bps71C</td>\r\n\t\t\t\t\t\t\t<td style=\"display: table-cell;\"></td>\r\n\t\t\t\t\t\t\t<td class=\"remain\">10</td>\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\r\n\t\t\t\t\t\t</tr>\r\n\t\t\t\t\t\t<tr>\r\n\t\t\t\t\t\t\t<th>4</th>\r\n\t\t\t\t\t\t\t<td>四等奖</td>\r\n\t\t\t\t\t\t\t<td>儿童益智玩具</td>\t\t\t\t\t\t\t\t\r\n\t\t\t\t\t\t\t<td style=\"display: table-cell;\">请直接到工作人员处领取</td>\r\n\t\t\t\t\t\t\t<td style=\"display: none;\"></td>\r\n\t\t\t\t\t\t\t<td class=\"remain\">10</td>\r\n\t\t\t\t\t\t</tr>\r\n\t\t\t\t\t\t<tr>\r\n\t\t\t\t\t\t\t<th>5</th>\r\n\t\t\t\t\t\t\t<td>五等奖</td>\r\n\t\t\t\t\t\t\t<td>龙星人定制钥匙扣</td>\t\t\t\t\t\t\t\t\r\n\t\t\t\t\t\t\t<td style=\"display: table-cell;\">请直接到工作人员处领取</td>\r\n\t\t\t\t\t\t\t<td style=\"display: none;\"></td>\r\n\t\t\t\t\t\t\t<td class=\"remain\">10</td>\r\n\t\t\t\t\t\t</tr>\r\n\t\t\t\t\t\t<tr>\r\n\t\t\t\t\t\t\t<th>6</th>\r\n\t\t\t\t\t\t\t<td>六等奖</td>\r\n\t\t\t\t\t\t\t<td>龙星人精美礼品</td>\r\n\t\t\t\t\t\t\t<td style=\"display: table-cell;\">请直接到工作人员处领取</td>\r\n\t\t\t\t\t\t\t<td style=\"display: none;\"></td>\r\n\t\t\t\t\t\t\t<td class=\"remain\">10</td>\r\n\t\t\t\t\t\t</tr>\r\n\t\t\t\t\t</tbody>\r\n\t\t\t\t</table>\r\n\t\t\t</div>\r\n\t\t</div>\r\n\t</div>\r\n\t<div id=\"other\" class=\"opacity o_position\" style=\"display: none;\"></div>\r\n\t<div id=\"chgif\" class=\"changegift position\" style=\"display: none;\">\r\n\t\t<form>\r\n\t\t\t<div class=\"form-header\">\r\n\t\t\t\t<h2>奖品信息修改</h2>\r\n\t\t\t\t<button type=\"button\" class=\"close\"  id=\"close\">×</button> \r\n\t\t\t</div>\r\n\t\t\t<div class=\"form-main\">\r\n\t\t\t\t<div class=\"form-input\">\r\n\t\t\t\t\t<label for=\"prizeId\">#: </label>\r\n\t\t\t\t\t<input id=\"prizeId\" type=\"text\" value=\"\" disabled=\"true\">\r\n\t\t\t\t</div>\r\n\t\t\t\t<div class=\"form-input\">\r\n\t\t\t\t\t<label for=\"grade\">奖项：</label>\r\n\t\t\t\t\t<input id=\"grade\" type=\"text\" value=\"\" disabled=\"true\">\r\n\t\t\t\t</div>\r\n\t\t\t\t<div class=\"form-input\">\r\n\t\t\t\t\t<label for=\"detail\">奖品详情：</label>\r\n\t\t\t\t\t<input id=\"detail\" type=\"text\" value=\"\">\r\n\t\t\t\t</div>\r\n\t\t\t\t<div class=\"form-input\">\r\n\t\t\t\t\t<label id=\"methodtext\" for=\"method\">领奖方式/二维码url：</label>\r\n  \t\t\t\t\t<input id=\"method\" type=\"text\" value=\"\">\r\n\t\t\t\t</div>\r\n\t\t\t\t<div class=\"form-input\">\r\n\t\t\t\t\t<label for=\"remain\">库存：</label>\r\n\t\t\t\t\t<input id=\"remain\" type=\"text\" value=\"\">\r\n\t\t\t\t</div>\r\n\t\t\t\t<div class=\"form-input\">\r\n\t\t\t\t\t<input id=\"ok\" type=\"button\" value=\"确认修改\">\r\n\t\t\t\t</div>\r\n\t\t\t</div>\r\n\t\t</form>\r\n\t</div>\r\n\t<div id=\"tip\" class=\"tip f_position\" style=\"display: none;\">\r\n\t\t修改成功\r\n\t</div>"

/***/ },
/* 22 */
/***/ function(module, exports) {

	module.exports = "<div class=\"luckyadmin\" style=\"display: block;\">\r\n<div class=\"winner-table\">\r\n\t<div class=\"winner\">\r\n\t\t获奖用户\r\n\t</div>\r\n\t<div class=\"info\">\r\n\t\t<table class=\"info-table\">\r\n\t\t\t<thead>\r\n\t\t\t\t<tr>\r\n\t\t\t\t\t<th>#</th>\r\n\t\t\t\t\t<th>姓名</th>\r\n\t\t\t\t\t<th>获奖时间</th>\r\n\t\t\t\t\t<th>奖项</th>\r\n\t\t\t\t\t<th>联系电话</th>\r\n\t\t\t\t\t<th>地址</th>\r\n\t\t\t\t\t<th>收件状态</th>\r\n\t\t\t\t</tr>\r\n\t\t\t</thead>\r\n\t\t\t<tbody id=\"infolist\">\r\n\t\t\t</tbody>\r\n\t\t</table>\r\n\t</div>\r\n</div>\r\n<center>\r\n\t<div id=\"changepage\" class=\"page\">\r\n\t\t<ul>\r\n\t\t\t<li id=\"forward\"><a>«</a></li>\r\n\t\t\t<li id=\"next\"><a>»</a></li>\r\n\t\t\t<li> \r\n\t\t\t\t\t\t<div class=\"jump\">\r\n\t\t\t\t\t\t\t跳转到第\r\n\t\t\t\t\t\t\t<input id=\"jumppage\" type=\"text\" value=\"\">\r\n\t\t\t\t\t\t\t页\r\n\t\t\t\t\t\t\t<button id=\"startjump\" type=\"button\">确定</button> \r\n\t\t\t\t\t\t</div>\r\n\t\t\t\t\t</li>\t\r\n\t\t</ul>\r\n\t</div><div id=\"tip\" class=\"tip f_position\" style=\"display: none;\"></div>\r\n</center>\r\n</div>"
...
/***/ function(module, exports, __webpack_require__) {
	...
	window.$ = _jquery2.default;
	window.jQuery = _jquery2.default;
	(0, _jquery2.default)("#navi-rewardpool").on("rewardpoolEvent", function () {
	    //读取第一页游戏信息
	    (0, _jquery2.default)(".data-loading").stop(true, true).fadeIn();
	    _jquery2.default.ajax({
	        type: 'POST',
	        ...
	        //async: false,
	        success: function success(data) {
	            (0, _jquery2.default)(".data-loading").stop(true, true).fadeOut(100);
	            if (data.resultCode !== "1") {
	                (0, _jquery2.default)(".alert-danger").html(data.resultMessage).stop(true, true).fadeIn(200).delay(1000).fadeOut(200);
	                return;
	            }
	            //$(".alert-success").html("成功获取游戏列表").stop(true, true).fadeIn(200).delay(1000).fadeOut(200);
	            for (var i = 0; i < data.apprules.length; i++) {
	                var poolin = 0;
	                var poolout = 0;
	                var poolinject = 0;
	                for (var j = 0; j < data.apprules[i].bonusPool.length; j++) {
	                ...
	                (0, _jquery2.default)("#reward-pool-tbody").append("<tr>\n                        <td>" + data.apprules[i].appId + "</td>\n                        <td>" + data.apprules[i].appName + "</td>\n                        <td>" + poolin + "</td>\n                        <td>" + poolinject + "</td>\n                            <td><span class=\"plus-tip-sig\" index=" + data.apprules[i].appId + ">+</span>\n                            <input class=\"pool-inject-input\" index=" + data.apprules[i].appId + " placehoder=\"\u6CE8\u5165\u91D1\u989D\">\n                            <button type=\"button\" class=\"btn btn-warning pool-request-btn\" index=" + data.apprules[i].appId + ">\u6CE8\u5165</button>\n                            <button type=\"button\" class=\"btn btn-success pool-submit-btn\" index=" + data.apprules[i].appId + ">\u786E\u5B9A</button>\n                        </td>\n                        <td>" + poolout + "</td>\n                    </tr>");
	                (0, _jquery2.default)("#reward-pool-tbody").trigger("ajaxCom");
	            }
	            for (var _i = 0; _i < data.pageNum; _i++) {
	                (0, _jquery2.default)("#game-nav-next").before("<li index=" + (_i + 1) + "><a>" + (_i + 1) + "</a></li>");
	            }
	            (0, _jquery2.default)(".game-list-nav li[index=\"1\"]").addClass("active-navipage");
	            (0, _jquery2.default)(".game-list-nav").attr("pageSum", data.pageNum);
	        },
	        error: function error(xhr, status, err) {
	            console.error(xhr.status, xhr.responseText, status, err.toString());
	            (0, _jquery2.default)(".data-loading").stop(true, true).fadeOut(100);
	            (0, _jquery2.default)(".alert-danger").html(xhr.responseText).stop(true, true).fadeIn(200).delay(1000).fadeOut(200);
	        }
	    });
	
	    //读取某一页游戏信息
	    (0, _jquery2.default)(".game-list-nav .pagination").click(function (data) {
	
	        var pageNow = parseInt((0, _jquery2.default)(".game-list-nav .active-navipage").attr("index"));
	        if (!isNaN((0, _jquery2.default)(data.target).html())) {
	            pageNow = parseInt((0, _jquery2.default)(data.target).closest('li').attr("index"));
	        } else if ((0, _jquery2.default)(data.target).html() === "«" && pageNow > 1) {
	            pageNow--;
	        } else if ((0, _jquery2.default)(data.target).html() === "»" && pageNow < parseInt((0, _jquery2.default)(".game-list-nav").attr("pageSum"))) {
	            pageNow++;
	        }
	        ...
	        _jquery2.default.ajax({
	            ...
	            success: function success(data) {
	                ...
	                if (pageNow > data.pageNum) {
	                    (0, _jquery2.default)(".game-list-nav .active-navipage").removeClass("active-navipage");
	                    (0, _jquery2.default)(".game-list-nav li[index=" + (pageNow - 1) + "]").addClass("active-navipage");
	                    (0, _jquery2.default)(".active-navipage a").trigger("click");
	                    return;
	                }
	                //$(".alert-success").html("成功获取游戏列表").stop(true, true).fadeIn(200).delay(1000).fadeOut(200);
	                if (data.resultCode !== "1") {
	                ...
	                (0, _jquery2.default)("#reward-pool-tbody").empty();
	                for (var i = 0; i < data.apprules.length; i++) {
	                    var poolin = 0;
	                    var poolout = 0;
	                    var poolinject = 0;
	                ...
	                (0, _jquery2.default)(".game-list-nav .pagination").html("<li><a>&laquo;</a></li><li id=\"game-nav-next\"><a>&raquo;</a></li>");
	                for (var _i2 = 0; _i2 < data.pageNum; _i2++) {
	                    (0, _jquery2.default)("#game-nav-next").before("<li index=" + (_i2 + 1) + "><a>" + (_i2 + 1) + "</a></li>");
	                }
	                (0, _jquery2.default)(".game-list-nav li[index=" + pageNow + "]").addClass("active-navipage");
	                (0, _jquery2.default)("#reward-pool-tbody").trigger("ajaxCom");
	            },
	            error: function error(xhr, status, err) {
	                console.error(xhr.status, xhr.responseText, status, err.toString());
	    ...
	    (0, _jquery2.default)("#reward-pool-tbody").on("ajaxCom", function () {
	        (0, _jquery2.default)(".pool-request-btn").on("click", function (data) {
	            var index = (0, _jquery2.default)(data.target).attr("index");
	            (0, _jquery2.default)(data.target).hide();
	            (0, _jquery2.default)(".plus-tip-sig[index=" + index + "]").show();
	            (0, _jquery2.default)(".pool-inject-input[index=" + index + "]").show();
	            (0, _jquery2.default)(".pool-submit-btn[index=" + index + "]").show();
	        });
	
	        (0, _jquery2.default)(".pool-submit-btn").on("click", function (data) {
	            var index = (0, _jquery2.default)(data.target).attr("index");
	            (0, _jquery2.default)(data.target).hide();
	            (0, _jquery2.default)(".plus-tip-sig[index=" + index + "]").hide();
	            (0, _jquery2.default)(".pool-inject-input[index=" + index + "]").hide();
	            (0, _jquery2.default)(".pool-request-btn[index=" + index + "]").show();
	        });
	    });
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	window.$ = _jquery2.default;
	window.jQuery = _jquery2.default;
	(0, _jquery2.default)("#navi-drawlog").on("drawlogEvent", function () {
		var time = new Date();
		...
		_jquery2.default.ajax({
			...
			success: function success(data) {
				...
				showRecords(data);
				(0, _jquery2.default)('#changepage #jumppage').val(index);
				changePage();
			}
		});
	
		(0, _jquery2.default)('#changepage #startjump').click(function () {
			index = (0, _jquery2.default)('#changepage #jumppage').val();
		...
		function showTip(str, time) {
			(0, _jquery2.default)('#tip').text(str).css('display', 'block');
			var setclock = setInterval(function () {
				(0, _jquery2.default)('#tip').css('display', 'none');
		...
		function showRecords(data) {
			// console.log(index);
			(0, _jquery2.default)('#changepage .num').remove();
			(0, _jquery2.default)('.info-table #infolist tr').remove();
			pageNum = data.pageNum;
			if (pageNum <= 9) {
				for (var i = 1; i <= data.pageNum; i++) {
					if (index == i) {
						var $li = (0, _jquery2.default)("<li class=num><a class=active>" + i + "</a></li>");
						(0, _jquery2.default)('#changepage #next').before($li);
					} else {
						var $li = (0, _jquery2.default)("<li class=num><a>" + i + "</a></li>");
						(0, _jquery2.default)('#changepage #next').before($li);
					}
				}
			} else {
				if (index <= 2) {
					...
					var $li = (0, _jquery2.default)("<li class=num>&nbsp...&nbsp</li> <li class=num><a>" + pageNum + "</a></li>");
					(0, _jquery2.default)('#changepage #next').before($li);
				} else if (pageNum - index <= 1) {
					//last1,2
					var $li = (0, _jquery2.default)("<li class=num><a>" + 1 + "</a></li> <li class=num>&nbsp...&nbsp</li>");
					(0, _jquery2.default)('#changepage #next').before($li);
			...
			if (data.records.length < pageSize) {
				for (var i = 0; i < data.records.length; i++) {
					var $tr = (0, _jquery2.default)("<tr>" + "<th>" + data.records[i].recordId + "</th>" + "<td>" + data.records[i].name + "</td>" + "<td>" + data.records[i].addTime + "</td>" + "<td>" + data.records[i].prizeId + "</td>" + "<td>" + data.records[i].phone + "</td>" + "<td>" + data.records[i].address + "</td>" + "<td>" + data.records[i].status + "</td>" + "</tr>");
					(0, _jquery2.default)('.info-table #infolist').append($tr);
				}
			} else {
		...
		function changePage() {
			(0, _jquery2.default)('#changepage .num').click(function () {
				if (index != (0, _jquery2.default)(this).text()) {
					index = (0, _jquery2.default)(this).text();
					_jquery2.default.ajax({
						url: "getRecordsAction",
						type: "POST",
						dataType: "json",
		...
		(0, _jquery2.default)('#changepage #forward').click(function () {
			index = (0, _jquery2.default)('#changepage .active').text();
			if (index != 1) {
				index--;
				_jquery2.default.ajax({
					url: "getRecordsAction",
		...
		(0, _jquery2.default)('#changepage #next').click(function () {
			index = (0, _jquery2.default)('#changepage .active').text();
			if (index != pageNum) {
				index++;
				_jquery2.default.ajax({
...
/***/ function(module, exports, __webpack_require__) {
	...
	window.$ = _jquery2.default;
	window.jQuery = _jquery2.default;
	(0, _jquery2.default)("#navi-gamerule").on("gameruleEvent", function () {
	    ...
	    _jquery2.default.ajax({
	        ...
	        success: function success(data) {
	            ...
	            //$(".alert-success").html("成功获取游戏列表").stop(true, true).fadeIn(200).delay(1000).fadeOut(200);
	            for (var i = 0; i < data.apprules.length; i++) {
	                (0, _jquery2.default)(".btn-group").append("<button type='button' class='btn btn-info select-game-btn' appid='" + data.apprules[i].appId + "'>" + data.apprules[i].appId + " " + data.apprules[i].appName + "</button>");
	            }
	            for (var _i = 0; _i < data.pageNum; _i++) {
	                (0, _jquery2.default)("#game-nav-next").before("<li index=" + (_i + 1) + "><a>" + (_i + 1) + "</a></li>");
	            }
	    ...
	    (0, _jquery2.default)(".game-list-nav .pagination").click(function (data) {
	        ...
	        _jquery2.default.ajax({
	            ...
	            success: function success(data) {
	                ...
	                (0, _jquery2.default)(".btn-group").html("<button type='button' class='btn btn-info select-game-btn' appid='" + data.apprules[0].appId + "'>" + data.apprules[0].appId + " " + data.apprules[0].appName + "</button>");
	                for (var i = 1; i < data.apprules.length; i++) {
	                    (0, _jquery2.default)(".btn-group").append("<button type='button' class='btn btn-info select-game-btn' appid='" + data.apprules[i].appId + "'>" + data.apprules[i].appId + " " + data.apprules[i].appName + "</button>");
	                }
	                (0, _jquery2.default)(".game-list-nav .pagination").html("<li><a>&laquo;</a></li><li id=\"game-nav-next\"><a>&raquo;</a></li>");
	                for (var _i2 = 0; _i2 < data.pageNum; _i2++) {
	    ...
	    //添加新游戏规则
	    (0, _jquery2.default)("#new-game-btn").click(function () {
	        (0, _jquery2.default)(".pop-mask").css("display", "block");
	        (0, _jquery2.default)(".new-game-form").css("display", "block");
	    });
	    (0, _jquery2.default)(".pop-close-btn").click(function () {
	        (0, _jquery2.default)(".pop-mask").css("display", "none");
	        (0, _jquery2.default)(".new-game-form").css("display", "none");
	        (0, _jquery2.default)(".delete-game-form").css("display", "none");
	    });
	    (0, _jquery2.default)(".pop-mask").click(function () {
	        (0, _jquery2.default)(".pop-mask").css("display", "none");
	        (0, _jquery2.default)(".new-game-form").css("display", "none");
	        (0, _jquery2.default)(".delete-game-form").css("display", "none");
	    });
	
	    (0, _jquery2.default)(".submit-new-gamerule").click(function () {
	        (0, _jquery2.default)(".data-loading").stop(true, true).fadeIn(100);
	        _jquery2.default.ajax({
	            type: 'POST',
	            url: 'setNewGameRuleAction',
	            data: { newGameRule: "{appId: " + (0, _jquery2.default)("#new-game-id").val() + ", price: " + (0, _jquery2.default)("#new-game-price").val() + ", basePoint: " + (0, _jquery2.default)("#new-game-basicpoint").val() + ", finalPoint: " + (0, _jquery2.default)("#new-game-finalpoint").val() + ", rewardSystems: [{  upPercentage: " + (0, _jquery2.default)("#new-game-upPercentageOne").val() + ", reward: " + (0, _jquery2.default)("#new-game-rewardOne").val() + "},{ upPercentage: " + (0, _jquery2.default)("#new-game-upPercentageTwo").val() + ", reward: " + (0, _jquery2.default)("#new-game-rewardTwo").val() + "}] }" },
	            dataType: 'json',
	            cache: false,
	            success: function success(data) {
	                (0, _jquery2.default)(".data-loading").stop(true, true).fadeOut(100);
	                ...
	                (0, _jquery2.default)(".alert-success").html("成功添加").stop(true, true).fadeIn(200).delay(1000).fadeOut(200);
	                (0, _jquery2.default)(".pop-mask").css("display", "none");
	                (0, _jquery2.default)(".new-game-form").css("display", "none");
	                (0, _jquery2.default)(".active-navipage a").trigger("click");
	            },
	    ...
	    //删除游戏规则
	    (0, _jquery2.default)("#delete-game-btn").click(function () {
	        (0, _jquery2.default)(".pop-mask").css("display", "block");
	        (0, _jquery2.default)(".delete-game-form").css("display", "block");
	    });
	    (0, _jquery2.default)(".delete-exist-gamerule").click(function () {
	        (0, _jquery2.default)(".data-loading").stop(true, true).fadeIn(100);
	        _jquery2.default.ajax({
	            type: 'POST',
	            url: 'deleteGameRuleAction',
	            data: { appid: (0, _jquery2.default)("#delete-game-id").val() },
	            dataType: 'json',
	            cache: false,
	            success: function success(data) {
	                (0, _jquery2.default)(".data-loading").stop(true, true).fadeOut(100);
	                ...
	                (0, _jquery2.default)(".alert-success").html("成功删除").stop(true, true).fadeIn(200).delay(1000).fadeOut(200);
	                (0, _jquery2.default)(".pop-mask").css("display", "none");
	                (0, _jquery2.default)(".delete-game-form").css("display", "none");
	                (0, _jquery2.default)(".active-navipage a").trigger("click");
	            },
	    ...
	    //查看某个游戏的规则
	    (0, _jquery2.default)(".btn-group").click(function (data) {
	        (0, _jquery2.default)(".data-loading").stop(true, true).fadeIn(100);
	        if ((0, _jquery2.default)(data.target).hasClass("select-game-btn")) {
	            var targetId = (0, _jquery2.default)(data.target).attr("appid");
	            (0, _jquery2.default)("#confirm-change-rule").attr("appid", targetId);
	            _jquery2.default.ajax({
	                type: 'POST',
	                ...
	                success: function success(data) {
	                    ...
	                    (0, _jquery2.default)(".exist-gamerule-table #basicpay").val(data.apprule.price);
	                    (0, _jquery2.default)(".exist-gamerule-table #basePoint").val(data.apprule.basePoint);
	                    (0, _jquery2.default)(".exist-gamerule-table #finalPoint").val(data.apprule.finalPoint);
	                    (0, _jquery2.default)(".exist-gamerule-table #upPercentageOne").val(data.apprule.rewardSystems[0].upPercentage).attr("rewardSystemId", data.apprule.rewardSystems[0].rewardSystemId);
	                    (0, _jquery2.default)(".exist-gamerule-table #rewardOne").val(data.apprule.rewardSystems[0].reward);
	                    (0, _jquery2.default)(".exist-gamerule-table #upPercentageTwo").val(data.apprule.rewardSystems[1].upPercentage).attr("rewardSystemId", data.apprule.rewardSystems[1].rewardSystemId);
	                    (0, _jquery2.default)(".exist-gamerule-table #rewardTwo").val(data.apprule.rewardSystems[1].reward);
	                },
	                error: function error(xhr, status, err) {
	                    console.error(xhr.status, xhr.responseText, status, err.toString());
	                    (0, _jquery2.default)(".data-loading").stop(true, true).fadeOut(100);
	            ...
	            (0, _jquery2.default)(".reward-rule-manager").hide();
	            (0, _jquery2.default)(".reward-rule-manager").slideDown();
	        }
	    });
	
	    //修改某个游戏的规则
	    (0, _jquery2.default)("#change-reward-rule").click(function () {
	        (0, _jquery2.default)("#change-reward-rule").hide();
	        (0, _jquery2.default)("#confirm-change-rule").show();
	        (0, _jquery2.default)("#upPercentageOne").removeAttr("disabled");
	        (0, _jquery2.default)("#rewardOne").removeAttr("disabled");
	        (0, _jquery2.default)("#basicpay").removeAttr("disabled");
	        (0, _jquery2.default)("#basePoint").removeAttr("disabled");
	        (0, _jquery2.default)("#finalPoint").removeAttr("disabled");
	        (0, _jquery2.default)("#upPercentageTwo").removeAttr("disabled");
	        (0, _jquery2.default)("#rewardTwo").removeAttr("disabled");
	    });
	    (0, _jquery2.default)("#confirm-change-rule").click(function () {
	        (0, _jquery2.default)("#confirm-change-rule").hide();
	        (0, _jquery2.default)("#change-reward-rule").show();
	        (0, _jquery2.default)("#upPercentageOne").attr("disabled", "disabled");
	        (0, _jquery2.default)("#rewardOne").attr("disabled", "disabled");
	        (0, _jquery2.default)("#basicpay").attr("disabled", "disabled");
	        (0, _jquery2.default)("#basePoint").attr("disabled", "disabled");
	        (0, _jquery2.default)("#finalPoint").attr("disabled", "disabled");
	        (0, _jquery2.default)("#upPercentageTwo").attr("disabled", "disabled");
	        (0, _jquery2.default)("#rewardTwo").attr("disabled", "disabled");
	        (0, _jquery2.default)(".data-loading").stop(true, true).fadeIn(100);
	        _jquery2.default.ajax({
	            type: 'POST',
	            url: 'setGameRuleAction',
	            data: { newGameRule: "{appId: " + (0, _jquery2.default)(this).attr("appid") + ", price: " + (0, _jquery2.default)("#basicpay").val() + ", basePoint: " + (0, _jquery2.default)("#basePoint").val() + ", finalPoint: " + (0, _jquery2.default)("#finalPoint").val() + ",rewardSystems: [{ rewardSystemId: " + (0, _jquery2.default)("#upPercentageOne").attr("rewardSystemId") + ", upPercentage: " + (0, _jquery2.default)("#upPercentageOne").val() + ", reward: " + (0, _jquery2.default)("#rewardOne").val() + "},{ rewardSystemId: " + (0, _jquery2.default)("#upPercentageTwo").attr("rewardSystemId") + ", upPercentage: " + (0, _jquery2.default)("#upPercentageTwo").val() + ", reward: " + (0, _jquery2.default)("#rewardTwo").val() + "}] }" },
	            dataType: 'json',
	            cache: false,
	            success: function success(data) {
	                (0, _jquery2.default)(".data-loading").stop(true, true).fadeOut(100);
	                ...
	                (0, _jquery2.default)(".alert-success").html("修改成功").stop(true, true).fadeIn(200).delay(1000).fadeOut(200);
	            },
	            error: function error(xhr, status, err) {
	                console.error(xhr.status, xhr.responseText, status, err.toString());
	                (0, _jquery2.default)(".data-loading").stop(true, true).fadeOut(100);
...
/***/ function(module, exports, __webpack_require__) {
	...
	window.$ = _jquery2.default;
	window.jQuery = _jquery2.default;
	(0, _jquery2.default)("#navi-ranking").on("rankingEvent", function () {
	    //读取第一页游戏信息
	    (0, _jquery2.default)(".data-loading").stop(true, true).fadeIn();
	    _jquery2.default.ajax({
	        type: 'POST',
	    ...
	    (0, _jquery2.default)(".btn-group").click(function (data) {
	        ...
	        if ((0, _jquery2.default)(data.target).hasClass("select-game-btn")) {
	            ...
	            _jquery2.default.ajax({
	                ...
	                success: function success(data) {
	                    ...
	                    if (data.appRanks.length > 0) {
	                        (0, _jquery2.default)("#game-ranking-tbody").html("<tr>\n                                <td>1</td>\n                                <td>" + data.appRanks[0].userId + "</td>\n                                <td>" + data.appRanks[0].point + "</td>\n                                <td>" + data.appRanks[0].addTime + "</td>\n                            </tr>");
	                        for (var i = 1; i < data.appRanks.length; i++) {
	                            (0, _jquery2.default)("#game-ranking-tbody").append("<tr>\n                                <td>" + (i + 1) + "</td>\n                                <td>" + data.appRanks[i].userId + "</td>\n                                <td>" + data.appRanks[i].point + "</td>\n                                <td>" + data.appRanks[i].addTime + "</td>\n                            </tr>");
	                        }
	                    } else {
	                        (0, _jquery2.default)("#game-ranking-tbody").empty();
	                        (0, _jquery2.default)(".alert-warning").html("暂无排名").stop(true, true).fadeIn(200).delay(1000).fadeOut(200);
	                    }
	                },
	                error: function error(xhr, status, err) {
	                    console.error(xhr.status, xhr.responseText, status, err.toString());
	            ...
	            (0, _jquery2.default)(".game-ranking").hide();
	            (0, _jquery2.default)(".game-ranking").slideDown();
	        }
	    });
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	window.$ = _jquery2.default;
	window.jQuery = _jquery2.default;
	(0, _jquery2.default)("#navi-rewardlog").on("rewardlogEvent", function () {
	    //读取第一页游戏信息
	    (0, _jquery2.default)(".data-loading").stop(true, true).fadeIn();
	    _jquery2.default.ajax({
	        type: 'POST',
	        ...
	        success: function success(data) {
	            ...
	            //$(".alert-success").html("成功获取游戏列表").stop(true, true).fadeIn(200).delay(1000).fadeOut(200);
	            for (var i = 0; i < data.appRunLogs.length; i++) {
	                (0, _jquery2.default)("#game-rewardlog-tbody").append("<tr>\n                        <td>" + data.appRunLogs[i].runLogId + "</td>\n                        <td>" + data.appRunLogs[i].userId + "</td>\n                        <td>" + data.appRunLogs[i].devGroupId + "</td>\n                        <td>" + data.appRunLogs[i].gameName + "</td>\n                        <td>" + data.appRunLogs[i].price + "</td>\n                        <td>" + data.appRunLogs[i].reward + "</td>\n                        <td>" + data.appRunLogs[i].addTime + "</td>\n                    </tr>");
	            }
	            for (var _i = 0; _i < data.pageNum; _i++) {
	                (0, _jquery2.default)("#log-nav-next").before("<li index=" + (_i + 1) + "><a>" + (_i + 1) + "</a></li>");
	            }
	            (0, _jquery2.default)(".normal-list-nav li[index=\"1\"]").addClass("active-navipage");
	            (0, _jquery2.default)(".normal-list-nav").attr("pageSum", data.pageNum);
	        },
	        error: function error(xhr, status, err) {
	            console.error(xhr.status, xhr.responseText, status, err.toString());
	            (0, _jquery2.default)(".data-loading").stop(true, true).fadeOut(100);
	    ...
	    //读取某一页游戏信息
	    (0, _jquery2.default)(".normal-list-nav .pagination").click(function (data) {
	
	        var pageNow = parseInt((0, _jquery2.default)(".normal-list-nav .active-navipage").attr("index"));
	
	        if (!isNaN((0, _jquery2.default)(data.target).html())) {
	            pageNow = parseInt((0, _jquery2.default)(data.target).closest('li').attr("index"));
	        } else if ((0, _jquery2.default)(data.target).html() === "«" && pageNow > 1) {
	            pageNow--;
	        } else if ((0, _jquery2.default)(data.target).html() === "»" && pageNow < parseInt((0, _jquery2.default)(".normal-list-nav").attr("pageSum"))) {
	            pageNow++;
	        }
	        ...
	        _jquery2.default.ajax({
	            ...
	            success: function success(data) {
	                (0, _jquery2.default)(".data-loading").stop(true, true).fadeOut(100);
	                if (pageNow > data.pageNum) {
	                    (0, _jquery2.default)(".normal-list-nav .active-navipage").removeClass("active-navipage");
	                    (0, _jquery2.default)(".normal-list-nav li[index=" + (pageNow - 1) + "]").addClass("active-navipage");
	                    (0, _jquery2.default)(".active-navipage a").trigger("click");
	                    return;
	                }
	                //$(".alert-success").html("成功获取游戏列表").stop(true, true).fadeIn(200).delay(1000).fadeOut(200);
	                ...
	                (0, _jquery2.default)("#game-rewardlog-tbody").html("<tr>\n                        <td>" + data.appRunLogs[0].runLogId + "</td>\n                        <td>" + data.appRunLogs[0].userId + "</td>\n                        <td>" + data.appRunLogs[0].devGroupId + "</td>\n                        <td>" + data.appRunLogs[0].gameName + "</td>\n                        <td>" + data.appRunLogs[0].price + "</td>\n                        <td>" + data.appRunLogs[0].reward + "</td>\n                        <td>" + data.appRunLogs[0].addTime + "</td>\n                    </tr>");
	                for (var i = 1; i < data.appRunLogs.length; i++) {
	                    (0, _jquery2.default)("#game-rewardlog-tbody").append("<tr>\n                        <td>" + data.appRunLogs[i].runLogId + "</td>\n                        <td>" + data.appRunLogs[i].userId + "</td>\n                        <td>" + data.appRunLogs[i].devGroupId + "</td>\n                        <td>" + data.appRunLogs[i].gameName + "</td>\n                        <td>" + data.appRunLogs[i].price + "</td>\n                        <td>" + data.appRunLogs[i].reward + "</td>\n                        <td>" + data.appRunLogs[i].addTime + "</td>\n                    </tr>");
	                }
	                (0, _jquery2.default)(".normal-list-nav .pagination").html("<li><a>&laquo;</a></li><li id=\"log-nav-next\"><a>&raquo;</a></li>");
	                for (var _i2 = 0; _i2 < data.pageNum; _i2++) {
	                    (0, _jquery2.default)("#log-nav-next").before("<li index=" + (_i2 + 1) + "><a>" + (_i2 + 1) + "</a></li>");
	                }
	                (0, _jquery2.default)(".normal-list-nav li[index=" + pageNow + "]").addClass("active-navipage");
	            },
	            error: function error(xhr, status, err) {
	                console.error(xhr.status, xhr.responseText, status, err.toString());
	                (0, _jquery2.default)(".data-loading").stop(true, true).fadeOut(100);
...
/***/ function(module, exports, __webpack_require__) {
	...
	window.$ = _jquery2.default;
	window.jQuery = _jquery2.default;
	(0, _jquery2.default)("#navi-prizemanager").on("prizemanagerEvent", function () {
		var time = new Date();
		var month = parseInt(time.getMonth()) + 1;
		var currentTime = time.getFullYear() + "-" + month + "-" + time.getDate();
		var prizeId;
		...
		showPrizes();
		(0, _jquery2.default)('#prizelist tr').click(function () {
			(0, _jquery2.default)('#chgif').css('display', 'block');
			(0, _jquery2.default)('body').addClass('scroll');
			(0, _jquery2.default)('#other').css('display', 'block');
			showInfo(this);
			olddetail = (0, _jquery2.default)(this).find('td').eq(1).text();
			oldtext = (0, _jquery2.default)(this).find('td').eq(2).text();
			oldinventory = (0, _jquery2.default)(this).find('td').eq(4).text();
		});
		(0, _jquery2.default)('#close').click(function () {
			(0, _jquery2.default)('#chgif').css('display', 'none');
			(0, _jquery2.default)('#other').css('display', 'none');
			// $('.home').removeClass('opacity');
		});
		(0, _jquery2.default)('#ok').click(function () {
			if ((0, _jquery2.default)('#detail').val() == "" || (0, _jquery2.default)('#method').val() == "" || (0, _jquery2.default)('#remain').val() == "") {
				// alert('缺少奖品信息');
				showTip("缺少奖品信息");
			} else if ((0, _jquery2.default)('#detail').val() == olddetail && (0, _jquery2.default)('#method').val() == oldtext && (0, _jquery2.default)('#remain').val() == oldinventory) {
				//alert('无改动');
				showTip("无改动");
			} else {
				savePrize();
				...
				(0, _jquery2.default)('#chgif').css('display', 'none');
				(0, _jquery2.default)('#other').css('display', 'none');
				(0, _jquery2.default)('body').removeClass('scroll');
				for (var i = 0; i < 6; i++) {
					var $th = (0, _jquery2.default)('#prizelist tr').eq(i).find('th');
					var $td = (0, _jquery2.default)('#prizelist tr').eq(i).find('td');
					if ($th.eq(0).text() == (0, _jquery2.default)('#prizeId').val()) {
						if ((0, _jquery2.default)('#method').val().indexOf("http") != -1) {
							$td.eq(1).text((0, _jquery2.default)('#detail').val());
							$td.eq(2).text((0, _jquery2.default)('#method').val()).css('display', 'none');
							$td.eq(4).text((0, _jquery2.default)('#remain').val());
							$td.eq(3).text("").css('display', 'table-cell').qrcode({
								render: "canvas",
								width: 60,
								height: 60,
								text: (0, _jquery2.default)('#method').val()
							});
						} else {
							$td.eq(1).text((0, _jquery2.default)('#detail').val());
							$td.eq(2).text((0, _jquery2.default)('#method').val()).css('display', 'table-cell');
							$td.eq(4).text((0, _jquery2.default)('#remain').val());
		...
		function showInfo(prize) {
			var $th = (0, _jquery2.default)(prize).find('th');
			var $td = (0, _jquery2.default)(prize).find('td');
			(0, _jquery2.default)('#prizeId').val($th.eq(0).text());
			(0, _jquery2.default)('#grade').val($td.eq(0).text());
			(0, _jquery2.default)('#detail').val($td.eq(1).text());
			(0, _jquery2.default)('#method').val($td.eq(2).text());
			(0, _jquery2.default)('#remain').val((0, _jquery2.default)(prize).find('.remain').text());
		...
		//将修改后的奖品信息入库
		function savePrize() {
			prizeId = (0, _jquery2.default)('#prizeId').val();
			name = (0, _jquery2.default)('#grade').val();
			detail = (0, _jquery2.default)('#detail').val();
			text = (0, _jquery2.default)('#method').val();
			inventory = (0, _jquery2.default)('#remain').val();
			_jquery2.default.ajax({
